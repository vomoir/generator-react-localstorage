...
export async function fetchRevenue() {
  ...
  try {
    ...
    const items = await db.all("SELECT * FROM revenue");
...
export async function fetchCustomers() {
  ...
  // Perform a database query to retrieve all items from the "customers" table
  const items = await db.all("SELECT * FROM customers order  by name asc");
...
export async function getUser(email: string) {
  ...
  // Perform a database query to retrieve all items from the "customers" table
  const items = await db.all(`SELECT * FROM users where email=${email}`);
